...
\begin{questions}
    ...
    \begin{parts}
        ...
        (\textbf{No es valido respuesta es `palabras'}) para describir la función.
        ...
        \part[] \textbf{(3pts)}Explique cual es la complejidad temporal de la solución del punto anterior.
        \part[] \textbf{(2pts)}La solución que propuso es Top-Down (TD) o Button-Up (BU)? Justifique.
